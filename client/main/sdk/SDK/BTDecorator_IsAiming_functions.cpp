...
#include "BTDecorator_IsAiming_classes.hpp"
#include "BTDecorator_IsAiming_parameters.hpp"
...
bool UBTDecorator_IsAiming_C::PerformConditionCheckAI(class AAIController* OwnerController_PerformConditionCheckAI, class APawn* ControlledPawn_PerformConditionCheckAI)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BTDecorator_IsAiming_C", "PerformConditionCheckAI");
