...
// Function Ultra_Dynamic_Sky.Ultra_Dynamic_Sky_C.Update Replicated Modifiers
// (Protected, BlueprintCallable, BlueprintEvent)

void AUltra_Dynamic_Sky_C::Update_Replicated_Modifiers()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Sky_C", "Update Replicated Modifiers");
...
// TArray<EUDS_CachedProperties>&          Properties                                             (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)

void AUltra_Dynamic_Sky_C::Update_Cache_Group_Boolean(EUDS_Cache_Group Group, TArray<EUDS_CachedProperties>& Properties)
{
	static class UFunction* Func = nullptr;
...
void AUltra_Dynamic_Sky_C::Three_Time_Floats(double Day, double Dusk, double Night, bool Cached, double* Out)
{
	static class UFunction* Func = nullptr;
...
void AUltra_Dynamic_Sky_C::Set_Fog(double Fog)
{
	static class UFunction* Func = nullptr;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// double                                  Dust_Amount                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AUltra_Dynamic_Sky_C::Set_Dust_Amount(double Dust_Amount)
{
	static class UFunction* Func = nullptr;
...
void AUltra_Dynamic_Sky_C::Set_Cloud_Coverage(double Cloud_Coverage)
{
	static class UFunction* Func = nullptr;
...
// const TArray<double>&                   Modifier_Alphas                                        (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
// const TArray<double>&                   Modifier_Targets                                       (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
// const TArray<double>&                   Modifier_Speeds                                        (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
void AUltra_Dynamic_Sky_C::Replicate_Modifier_State(const TArray<class UUDS_Modifier_C*>& Modifiers, const TArray<double>& Modifier_Alphas, const TArray<double>& Modifier_Targets, const TArray<double>& Modifier_Speeds, const bool Hard_Reset)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Modifier_Alphas = std::move(Modifier_Alphas);
	Parms.Modifier_Targets = std::move(Modifier_Targets);
	Parms.Modifier_Speeds = std::move(Modifier_Speeds);
...
void AUltra_Dynamic_Sky_C::ReceiveTick(float DeltaSeconds_ReceiveTick)
{
	static class UFunction* Func = nullptr;
...
void AUltra_Dynamic_Sky_C::ReceiveEndPlay(EEndPlayReason EndPlayReason_ReceiveEndPlay)
{
	static class UFunction* Func = nullptr;
...
void AUltra_Dynamic_Sky_C::Number_of_Days_in_a_Year(int32 Year, int32* Count)
{
	static class UFunction* Func = nullptr;
...
void AUltra_Dynamic_Sky_C::Get_Cloud_Coverage_0_3(double* Cloud_Coverage)
{
	static class UFunction* Func = nullptr;
...
void AUltra_Dynamic_Sky_C::Get_Cloud_Coverage_0_10(double* Cloud_Coverage)
{
	static class UFunction* Func = nullptr;
...
void AUltra_Dynamic_Sky_C::Editor_Tick(const struct FVector& Editor_Camera_Location, const struct FRotator& Editor_Camera_Rotation, bool Sequencer_Open)
{
	static class UFunction* Func = nullptr;
...
void AUltra_Dynamic_Sky_C::Day_Count_at_the_Start_of_a_Month(int32 Year, int32 Month, int32* Count)
{
	static class UFunction* Func = nullptr;
...
void AUltra_Dynamic_Sky_C::Date_and_Time_to_Year_Progress(int32 Month, int32 Day, double Time, double* Days_from_Start_of_Year)
{
	static class UFunction* Func = nullptr;
...
void AUltra_Dynamic_Sky_C::Current_Solar_Eclipse_Values(double* Eclipse_Percent, struct FLinearColor* Tint_Color)
{
	static class UFunction* Func = nullptr;
...
void AUltra_Dynamic_Sky_C::Current_Month_Lengths(int32 Year, TArray<int32>* Lengths)
{
	static class UFunction* Func = nullptr;
...
void AUltra_Dynamic_Sky_C::Check_If_Year_is_Leap_Year(int32 Year, bool* Leap_Year)
{
	static class UFunction* Func = nullptr;
