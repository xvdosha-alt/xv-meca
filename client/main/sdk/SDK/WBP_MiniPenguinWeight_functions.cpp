...
#include "WBP_MiniPenguinWeight_classes.hpp"
#include "WBP_MiniPenguinWeight_parameters.hpp"
...
void UWBP_MiniPenguinWeight_C::SetColor(const struct FLinearColor& Color, int32 Index_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_MiniPenguinWeight_C", "SetColor");

	Params::WBP_MiniPenguinWeight_C_SetColor Parms{};
