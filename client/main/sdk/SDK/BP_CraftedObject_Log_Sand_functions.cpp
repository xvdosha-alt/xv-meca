...
#include "BP_CraftedObject_Log_Sand_classes.hpp"
#include "BP_CraftedObject_Log_Sand_parameters.hpp"


SDK_NAMESPACE_START

// Function BP_CraftedObject_Log_Sand.BP_CraftedObject_Log_Sand_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)

void ABP_CraftedObject_Log_Sand_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_CraftedObject_Log_Sand_C", "ReceiveBeginPlay");
...
void ABP_CraftedObject_Log_Sand_C::ReceiveActorBeginOverlap(class AActor* OtherActor_ReceiveActorBeginOverlap)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_CraftedObject_Log_Sand_C", "ReceiveActorBeginOverlap");

	Params::BP_CraftedObject_Log_Sand_C_ReceiveActorBeginOverlap Parms{};
...
void ABP_CraftedObject_Log_Sand_C::IsChangeImage(bool* IsInteract_IsChangeImage, class FText* OverrideText_IsChangeImage)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_CraftedObject_Log_Sand_C", "IsChangeImage");

	Params::BP_CraftedObject_Log_Sand_C_IsChangeImage Parms{};
...
void ABP_CraftedObject_Log_Sand_C::GetItemInfo(ENUM_HandType* HandType_GetItemInfo, ENUM_ClassType* ClassType_GetItemInfo, bool* NotPickUp_GetItemInfo, struct FRotator* HaveRotation_GetItemInfo, struct FVector* Add_Position_GetItemInfo, bool* IsBoneAttach_GetItemInfo, ENUM_ItemBindType* BindType_GetItemInfo, class FName* BoneName_GetItemInfo, struct FST_ItemCoreDatas* CoreDatas_GetItemInfo)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_CraftedObject_Log_Sand_C", "GetItemInfo");

	Params::BP_CraftedObject_Log_Sand_C_GetItemInfo Parms{};
