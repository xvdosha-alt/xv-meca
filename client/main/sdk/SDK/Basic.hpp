...
namespace Offsets
{
	constexpr int32 GObjects          = 0x09F3E750;
	constexpr int32 AppendString      = 0x013B3340;
	constexpr int32 GNames            = 0x09E220F8;
	constexpr int32 GWorld            = 0x09C87620;
	constexpr int32 ProcessEvent      = 0x015D0B80;
