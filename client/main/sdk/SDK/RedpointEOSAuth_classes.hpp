...
// Class RedpointEOSAuth.RedpointEOSAuthWidgetFactory
// 0x0000 (0x0000 - 0x0000)
class IRedpointEOSAuthWidgetFactory final
{
public:
...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("RedpointEOSAuthWidgetFactory")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"RedpointEOSAuthWidgetFactory")
	}
	static class IRedpointEOSAuthWidgetFactory* GetDefaultObj()
	{
		return GetDefaultObjImpl<IRedpointEOSAuthWidgetFactory>();
	}
...
DUMPER7_ASSERTS_IRedpointEOSAuthWidgetFactory;
