...
#include "WBP_LINK_goal2_classes.hpp"
#include "WBP_LINK_goal2_parameters.hpp"
...
void UWBP_LINK_goal2_C::SetColor(const struct FLinearColor& Color, int32 Index_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_LINK_goal2_C", "SetColor");

	Params::WBP_LINK_goal2_C_SetColor Parms{};
